...
<head>
	...
	<link rel="stylesheet" href="/mango/css/mui.min.css?v=<?php echo time()?>">
	<link rel="stylesheet" type="text/css" href="/mango/css/mui.picker.min.css" />
	<script src="/mango/js/jquery.min.js"></script>
	<script src="/mango/js/mui.min.js "></script>
	<script src="/mango/js/mui.view.js "></script>
	<script src="/mango/js/mui.picker.min.js"></script>
	<script src="/mango/js/main.js?v=<?php echo time()?>"></script>
	<style>
		html,
		body,
		.mui-content {
		...
		.mui-table-view:before,.mui-input-group:after{
			height:0px;
		}
		.mui-right-30{
			margin-right: 30px;
...
<div class="mui-content" id="view-frame-buyers-add-address">
	<div id="view_inner_buyers_add_address" class="mui-content">
		...
		<ul class="mui-table-view">
			<li class="mui-table-view-cell">
				<a href="#" id="change_address" class="mui-navigate-right mui-padding-left-10">所在地区<span class="mui-pull-right mui-right-30">请选择</span></a>
			</li>
		</ul>
		<div class="mui-input-row">
			<textarea id="textarea" rows="5" placeholder="请填写详细收货地址，不少于5个字"></textarea>
		</div>
		<ul class="mui-table-view mui-top-border">
			<li class="mui-table-view-cell">
				<span>设为默认</span>
